...
public interface ICsvMapWriter extends ICsvWriter {
	...
	/**
	 * Write the map into a line of the csv file. Note that the <tt>writer</tt> provided in the argument will be
	 * wrapped in a <tt>BufferedWriter</tt> before accessed.
	 * 
	 * @param values

...
/**
 * Convert a string to a boolean while ignoring case. 
 * The strings "true", "false", "0", "1", "N", "Y", "F", "T" are 
...
public class ParseBool extends CellProcessorAdaptor {
	...
	private static String[] DEFAULT_TRUE_VALUES = new String[] {
		"1",
		"true",
		"t",
		"y"
	...
	private static String[] DEFAULT_FALSE_VALUES = new String[] {
		"0",
		"false",
		"f",
		"n"
	...
	public Object execute(final Object value, final CSVContext context) throws SuperCSVException {
		...
		if(isFalseValue(sval)) {
			...
			throw new SuperCSVException("Cannot parse \"" + value + "\" to a boolean", 
					context, this);
		}

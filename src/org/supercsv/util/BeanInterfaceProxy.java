...
public class BeanInterfaceProxy implements InvocationHandler {
	...
	/**
	 * {@inheritDoc} This method is invoked every time a method is invoked on our proxy. getMethods returns the value
	 * they hold or null. SetMethods sets the state given by the first argument and returns itself (to use it with
	 * method chaining)
	 */
	public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
		if(method.getName().startsWith("get")) {
			return beanState.get(method.getName().substring(3));
		}

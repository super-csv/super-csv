...
public class ParseTimeTest {
	...
	@Before
	public void setUp() {
		processor = new ParseTime(TIME_FORMAT);
		processor2 = new ParseTime(TIME_FORMAT, true);
		processor3 = new ParseTime(TIME_FORMAT, false);
		processorChain = new ParseTime(TIME_FORMAT, new IdentityTransform());
		processorChain2 = new ParseTime(TIME_FORMAT, true, new IdentityTransform());
		processorChain3 = new ParseTime(TIME_FORMAT, false, new IdentityTransform());
	}
	...
	public void testLocaleConstructorWithNullDateFormat() {
		new ParseTime(null, false, Locale.GERMAN);
	}
	...
	public void testLocaleConstructorWithNullLocale() {
		new ParseTime(TIME_FORMAT, false, (Locale) null);
	}

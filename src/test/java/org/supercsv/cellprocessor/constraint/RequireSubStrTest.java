	...
	public void constructors_should_hande_valid_input() {
		...
		// constructor 2
		{
			...
			Assert.assertEquals(true,
				new RequireSubStr(strl, new ComparerCellProcessor("abba")).execute("abba", CSVCONTEXT));
		}
		// constructor 3
		Assert.assertEquals(true,
			new RequireSubStr("abba", new ComparerCellProcessor("abba")).execute("abba", CSVCONTEXT));

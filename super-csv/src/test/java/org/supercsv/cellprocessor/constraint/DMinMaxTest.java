...
public class DMinMaxTest {
	...
	public void testValidDouble() {
		assertEquals((Object) IN_RANGE, processor.execute(IN_RANGE, ANONYMOUS_CSVCONTEXT));
		assertEquals((Object) IN_RANGE, processorChain.execute(IN_RANGE, ANONYMOUS_CSVCONTEXT));
	}
	...
	public void testValidString() {
		assertEquals((Object) IN_RANGE, processor.execute(String.valueOf(IN_RANGE), ANONYMOUS_CSVCONTEXT));
		assertEquals((Object) IN_RANGE, processorChain.execute(String.valueOf(IN_RANGE), ANONYMOUS_CSVCONTEXT));
	}
	...
	public void testChainedAfterStringCellProcessor() {
		...
		assertEquals((Object) 0.0, chain.execute("zero", ANONYMOUS_CSVCONTEXT));
	}

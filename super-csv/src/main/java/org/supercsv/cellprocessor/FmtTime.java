 ...
 * String to a Time, use the {@link ParseTime} processor.
 * <p>
 ...
 * @since 2.4.0
 */
public class FmtTime extends CellProcessorAdaptor implements DateCellProcessor {
	 ...
	 */
	public FmtTime(final String dateFormat) {
		super();
	 ...
	 */
	public FmtTime(final String dateFormat, final StringCellProcessor next) {
		super(next);
		checkPreconditions(dateFormat);
		this.dateFormat = dateFormat;
	}

...
public class Required extends RequireHashCode {
	...
	/**
	 * Constructs a new <tt>Required</tt> processor, which converts the input to a String, and ensures that the input's
	 * hash function matches any of a given set of hashcodes.
	 * 
	...
	/**
	 * Constructs a new <tt>Required</tt> processor, which converts the input to a String, ensures that the input's hash
	 * function matches the supplied hashcode, then calls the next processor in the chain.
	 * 
	...
	/**
	 * Constructs a new <tt>Required</tt> processor, which converts the input to a String, ensures that the input's hash
	 * function matches any of a given set of hashcodes, then calls the next processor in the chain.
	 * 
	 * @param requiredHashcodes
	 *            one or more hashcodes
	 * @param next

...
public class FmtTimeTest {
	...
	@Before
	public void setUp() {
		processor = new FmtTime(TIME_FORMAT);
		processorChain = new FmtTime(TIME_FORMAT, new IdentityTransform());
	}
	...
	public void testWithInvalidDateFormat() {
		CellProcessor invalidDateFormatProcessor = new FmtTime("abcd");

...
public class TokenTest {
	...
	public void testChainedConstructon() throws Exception {
		...
		Assert.assertEquals("new ret val for new magic token", "bar",
	...
	public void testChaining() throws Exception {
		...
		Assert.assertEquals("magic token works before parsing number", 0,
			ccp.execute("[empty]", TestConstants.ANONYMOUS_CSVCONTEXT));
	}
